export function RepositoryCard({ repository }) {
  return (
    <a
      className="rounded-xl border border-gray-300 bg-white p-5 text-black transition hover:border-black hover:shadow-md"
      href={repository.htmlUrl}
      rel="noreferrer"
      target="_blank"
    >
      <h2 className="font-semibold text-black">{repository.fullName}</h2>
